...
def get_chart(verb):
    ...
    #print arabic_root
    he_past_broken = [alif, first_root_letter, sukun, tah, fatha, second_root_letter, fatha, third_root_letter]
    ...
    i_past_broken = [alif, first_root_letter, sukun, tah, fatha, second_root_letter, fatha, third_root_letter, sukun, tah]
    i_past_string = "".join(i_past_broken)
    i_present_b_broken = [bah, fatha, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, kasra, third_root_letter]
    i_present_b_string = "".join(i_present_b_broken)
    i_command_string = ""
    i_present_broken = [alif_hamza_above, fatha, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, kasra, third_root_letter]
    i_present_string = "".join(i_present_broken)
    i_present_with_pronoun_broken = [alif_hamza_above, fatha, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, kasra, third_root_letter, sukun, hah, damma, meem]
    ...
    you_m_past_broken = [alif, first_root_letter, sukun, tah, fatha, second_root_letter, fatha, third_root_letter, sukun, tah]
    you_m_past_string = "".join(you_m_past_broken)
    you_m_present_b_broken = [bah, sukun, tah, kasra, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, kasra, third_root_letter]
    you_m_present_b_string = "".join(you_m_present_b_broken)
    you_m_command_broken = [alif, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, kasra, third_root_letter]
    you_m_command_string = "".join(you_m_command_broken)
    you_m_present_broken = [tah, kasra, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, kasra, third_root_letter]
    you_m_present_string = "".join(you_m_present_broken)
    you_m_present_with_pronoun_broken = [tah, kasra, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, kasra, third_root_letter, damma, hah]
    ...
    you_f_past_broken = [alif, first_root_letter, sukun, tah, fatha, second_root_letter, fatha, third_root_letter, sukun, tah, kasra, yah]
    you_f_past_string = "".join(you_f_past_broken)
    you_f_present_b_broken = [bah, sukun, tah, kasra, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, sukun, third_root_letter, kasra, yah]
    you_f_present_b_string = "".join(you_f_present_b_broken)
    you_f_command_broken = [alif, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, sukun, third_root_letter, kasra, yah]
    you_f_command_string = "".join(you_f_command_broken)
    you_f_present_broken = [tah, kasra, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, sukun, third_root_letter, kasra, yah]
    you_f_present_string = "".join(you_f_present_broken)
    you_f_present_with_pronoun_broken = [tah, kasra, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, sukun, third_root_letter, kasra, yah, hah, alif]
    ...
    he_past_broken = [alif, first_root_letter, sukun, tah, fatha, second_root_letter, fatha, third_root_letter]
    he_past_string = "".join(he_past_broken)
    he_present_b_broken = [bah, kasra, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, kasra, third_root_letter]
    he_present_b_string = "".join(he_present_b_broken)
    he_command_string = ""
    he_present_broken = [yah, kasra, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, kasra, third_root_letter]
    he_present_string = "".join(he_present_broken)
    he_present_with_pronoun_broken = [yah, kasra, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, kasra, third_root_letter, fatha, kaaf]
    ...
    she_past_broken = [alif, first_root_letter, sukun, tah, fatha, second_root_letter, sukun, third_root_letter, fatha, tah]
    she_past_string = "".join(she_past_broken)
    she_present_b_broken = [bah, sukun, tah, kasra, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, kasra, third_root_letter]
    she_present_b_string = "".join(she_present_b_broken)
    she_command_string = ""
    she_present_broken = [tah, kasra, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, kasra, third_root_letter]
    she_present_string = "".join(she_present_broken)
    she_present_with_pronoun_broken = [tah, kasra, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, kasra, third_root_letter, kasra, kaaf]
    ...
    we_past_broken = [alif, first_root_letter, sukun, tah, fatha, second_root_letter, fatha, third_root_letter, sukun, noon, alif]
    we_past_string = "".join(we_past_broken)
    we_present_b_broken = [meem, sukun, noon, kasra, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, kasra, third_root_letter]
    we_present_b_string = "".join(we_present_b_broken)
    we_command_string = ""
    we_present_broken = [noon, kasra, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, kasra, third_root_letter]
    we_present_string = "".join(we_present_broken)
    we_present_with_pronoun_broken = [noon, kasra, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, kasra, third_root_letter, sukun, kaaf, damma, meem]
    ...
    you_all_past_broken = [alif, first_root_letter, sukun, tah, fatha, second_root_letter, fatha, third_root_letter, sukun, tah, damma, waw, alif]
    you_all_past_string = "".join(you_all_past_broken)
    you_all_present_b_broken = [bah, sukun, tah, kasra, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, sukun, third_root_letter, damma, waw, alif]
    you_all_present_b_string = "".join(you_all_present_b_broken)
    you_all_command_broken = [alif, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, sukun, third_root_letter, damma, waw, alif]
    you_all_command_string = "".join(you_all_command_broken)
    you_all_present_broken = [tah, kasra, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, sukun, third_root_letter, damma, waw, alif]
    you_all_present_string = "".join(you_all_present_broken)
    you_all_present_with_pronoun_broken = [tah, kasra, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, sukun, third_root_letter, damma, waw, noon, alif]
    ...
    they_past_broken = [alif, first_root_letter, sukun, tah, fatha, second_root_letter, fatha, third_root_letter, damma, waw, alif]
    they_past_string = "".join(they_past_broken)
    they_present_b_broken = [bah, kasra, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, sukun, third_root_letter, damma, waw, alif]
    they_present_b_string = "".join(they_present_b_broken)
    they_command_string = ""
    they_present_broken = [yah, kasra, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, sukun, third_root_letter, damma, waw, alif]
    they_present_string = "".join(they_present_broken)
    they_present_with_pronoun_broken = [yah, kasra, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, sukun, third_root_letter, damma, waw, noon, kasra, yah]
    ...
    active_participle_broken = [meem, damma, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, kasra, third_root_letter]
    active_participle_string = "".join(active_participle_broken)
    direct_object_broken = [meem, damma, first_root_letter, sukun, tah, fatha, hamza_on_alif_maksura, fatha, third_root_letter]
    direct_object_string = "".join(direct_object_broken)
    verbal_noun_broken = [alif, first_root_letter, sukun, tah, kasra, hamza_on_alif_maksura, alif, third_root_letter]
