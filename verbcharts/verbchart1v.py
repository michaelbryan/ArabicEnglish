...
def get_chart(verb):
    ...
    i_command_string = ""
    i_present_broken = [alif_maddah, second_root_letter, kasra, third_root_letter]
    i_present_string = "".join(i_present_broken)
    i_present_with_pronoun_broken = [alif_maddah, second_root_letter, kasra, third_root_letter, sukun, hah, damma, meem]
    ...
    you_f_present_b_broken = [bah, kasra, tah, sukun, alif_maddah, second_root_letter, kasra, third_root_letter, kasra, yah]
    you_f_present_b_string = "".join(you_f_present_b_broken)
    you_f_command_broken = [alif_maddah, second_root_letter, kasra, third_root_letter, kasra, yah]
    you_f_command_string = "".join(you_f_command_broken)
    you_f_present_broken = [tah, sukun, alif_maddah, second_root_letter, kasra, third_root_letter, kasra, yah]
    you_f_present_string = "".join(you_f_present_broken)
    you_f_present_with_pronoun_broken = [tah, sukun, alif_maddah, second_root_letter, kasra, third_root_letter, kasra, yah, hah, alif]
    ...
    he_command_string = ""
    he_present_broken = [yah, kasra, alif_maddah, second_root_letter, kasra, third_root_letter]
    he_present_string = "".join(he_present_broken)
    he_present_with_pronoun_broken = [yah, kasra, alif_maddah, second_root_letter, kasra, third_root_letter, fatha, kaaf]
    ...
    you_all_present_b_broken = [bah, kasra, tah, sukun, alif_maddah, second_root_letter, kasra, third_root_letter, damma, waw, alif]
    you_all_present_b_string = "".join(you_all_present_b_broken)
    you_all_command_broken = [alif_maddah, second_root_letter, kasra, third_root_letter, damma, waw, alif]
    you_all_command_string = "".join(you_all_command_broken)
    you_all_present_broken = [tah, sukun, alif_maddah, second_root_letter, kasra, third_root_letter, damma, waw, alif]
    you_all_present_string = "".join(you_all_present_broken)
    you_all_present_with_pronoun_broken = [tah, sukun, alif_maddah, second_root_letter, kasra, third_root_letter, damma, waw, noon, alif]
    ...
    they_present_b_broken = [bah, kasra, alif_maddah, second_root_letter, kasra, third_root_letter, damma, waw, alif]
    they_present_b_string = "".join(they_present_b_broken)
    they_command_string = ""
    they_present_broken = [yah, kasra, alif_maddah, second_root_letter, kasra, third_root_letter, damma, waw, alif]
    they_present_string = "".join(they_present_broken)
    they_present_with_pronoun_broken = [yah, kasra, alif_maddah, second_root_letter, kasra, third_root_letter, damma, waw, noon, kasra, yah]
