...
def get_chart(verb):
    ...
    #print arabic_root
    he_past_broken = [alif_hamza_above, fatha, first_root_letter, sukun, second_root_letter, fatha, third_root_letter]
    ...
    i_past_broken = [alif_hamza_above, fatha, first_root_letter, sukun, second_root_letter, fatha, third_root_letter, sukun, tah]
    ...
    you_m_past_broken = [alif_hamza_above, fatha, first_root_letter, sukun, second_root_letter, fatha, third_root_letter, sukun, tah]
    ...
    you_f_past_broken = [alif_hamza_above, fatha, first_root_letter, sukun, second_root_letter, fatha, third_root_letter, sukun, tah, kasra, yah]
    ...
    she_past_broken = [alif_hamza_above, fatha, first_root_letter, sukun, second_root_letter, sukun, third_root_letter, fatha, tah]
    ...
    we_past_broken = [alif_hamza_above, fatha, first_root_letter, sukun, second_root_letter, fatha, third_root_letter, sukun, noon, alif]
    ...
    you_all_past_broken = [alif_hamza_above, fatha, first_root_letter, sukun, second_root_letter, fatha, third_root_letter, sukun, tah, damma, waw, alif]
    ...
    they_past_broken = [alif_hamza_above, fatha, first_root_letter, sukun, second_root_letter, fatha, third_root_letter, damma, waw, alif]
    ...
    active_participle_broken = [meem, damma, first_root_letter, sukun, second_root_letter, kasra, third_root_letter]
    active_participle_string = "".join(active_participle_broken)
    direct_object_broken = [meem, damma, first_root_letter, sukun, second_root_letter, fatha, third_root_letter]
