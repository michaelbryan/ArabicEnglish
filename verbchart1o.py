...
class Entry:
    ...
    def verb_chart_1o(self):
        ...
        i_command_string = ""
        i_present_broken = [alif_madda, second_root_letter, kasra, yah]
        i_present_string = "".join(i_present_broken)
        i_present_with_pronoun_broken = [alif_madda, second_root_letter, kasra, yah, hah, damma, meem]
