...
def get_chart(verb):
    ...
    active_participle_broken = [first_root_letter, alif, second_root_letter, kasra, yah]
    active_participle_string = "".join(active_participle_broken)
    direct_object_broken = [meem, fatha, first_root_letter, sukun, second_root_letter, kasra, yah]
    direct_object_string = "".join(direct_object_broken)
    verbal_noun_broken = [first_root_letter, fatha, second_root_letter, kasra, yah]
    verbal_noun_string = "".join(verbal_noun_broken)
    verbal_noun_broken2 = [first_root_letter, kasra, second_root_letter, alif, yah, tah_marbuuta]
