...
def get_chart(verb):
    ...
    you_m_present_b_broken = [bah, sukun, tah, kasra, first_root_letter, sukun, second_root_letter, kasra, yah]
    you_m_present_b_string = "".join(you_m_present_b_broken)
    you_m_command_broken = [alif_hamza_below, kasra, first_root_letter, sukun, second_root_letter, kasra, yah]
    you_m_command_string = "".join(you_m_command_broken)
    you_m_present_broken = [tah, kasra, first_root_letter, sukun, second_root_letter, kasra, yah]
    you_m_present_string = "".join(you_m_present_broken)
    you_m_present_with_pronoun_broken = [tah, kasra, first_root_letter, sukun, second_root_letter, kasra, yah, hah]
    ...
    you_f_present_b_broken = [bah, sukun, tah, kasra, first_root_letter, sukun, second_root_letter, kasra, yah]
    you_f_present_b_string = "".join(you_f_present_b_broken)
    you_f_command_broken = [alif_hamza_below, kasra, first_root_letter, sukun, second_root_letter, kasra, yah]
    you_f_command_string = "".join(you_f_command_broken)
    you_f_present_broken = [tah, kasra, first_root_letter, sukun, second_root_letter, kasra, yah]
    you_f_present_string = "".join(you_f_present_broken)
    you_f_present_with_pronoun_broken = [tah, kasra, first_root_letter, sukun, second_root_letter, kasra, yah, hah, alif]
    ...
    he_past_broken = [alif_hamza_above, fatha, first_root_letter, sukun, second_root_letter, third_root_letter]
    he_past_string = "".join(he_past_broken)
    he_present_b_broken = [bah, kasra, first_root_letter, sukun, second_root_letter, kasra, yah]
    he_present_b_string = "".join(he_present_b_broken)
    he_command_string = ""
    he_present_broken = [yah, kasra, first_root_letter, sukun, second_root_letter, kasra, yah]
    he_present_string = "".join(he_present_broken)
    he_present_with_pronoun_broken = [yah, kasra, first_root_letter, sukun, second_root_letter, kasra, yah, kaaf]
    ...
    she_present_b_broken = [bah, sukun, tah, kasra, first_root_letter, sukun, second_root_letter, kasra, yah]
    she_present_b_string = "".join(she_present_b_broken)
    she_command_string = ""
    she_present_broken = [tah, kasra, first_root_letter, sukun, second_root_letter, kasra, yah]
    she_present_string = "".join(she_present_broken)
    she_present_with_pronoun_broken = [tah, kasra, first_root_letter, sukun, second_root_letter, kasra, yah, kaaf, kasra, yah]
    ...
    we_present_b_broken = [meem, sukun, noon, kasra, first_root_letter, sukun, second_root_letter, kasra, yah]
    we_present_b_string = "".join(we_present_b_broken)
    we_command_string = ""
    we_present_broken = [noon, kasra, first_root_letter, sukun, second_root_letter, kasra, yah]
    we_present_string = "".join(we_present_broken)
    we_present_with_pronoun_broken = [noon, kasra, first_root_letter, sukun, second_root_letter, kasra, yah, sukun, kaaf, damma, meem]
    ...
    you_all_present_b_broken = [bah, sukun, tah, kasra, first_root_letter, sukun, second_root_letter, damma, waw, alif]
    you_all_present_b_string = "".join(you_all_present_b_broken)
    you_all_command_broken = [alif_hamza_below, kasra, first_root_letter, sukun, second_root_letter, damma, waw, alif]
    you_all_command_string = "".join(you_all_command_broken)
    you_all_present_broken = [tah, kasra, first_root_letter, sukun, second_root_letter, damma, waw, alif]
    you_all_present_string = "".join(you_all_present_broken)
    you_all_present_with_pronoun_broken = [tah, kasra, first_root_letter, sukun, second_root_letter, damma, waw, noon, alif]
    ...
    they_present_b_broken = [bah, kasra, first_root_letter, sukun, second_root_letter, damma, waw, alif]
    they_present_b_string = "".join(they_present_b_broken)
    they_command_string = ""
    they_present_broken = [yah, kasra, first_root_letter, sukun, second_root_letter, damma, waw, alif]
    they_present_string = "".join(they_present_broken)
    they_present_with_pronoun_broken = [yah, kasra, first_root_letter, sukun, second_root_letter, damma, waw, noon, kasra, yah]
