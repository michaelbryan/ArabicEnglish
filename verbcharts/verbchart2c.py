...
def get_chart(verb):
    ...
    he_past_broken = [first_root_letter, fatha, second_root_letter, damma, fatha, third_root_letter]
    he_past_string = "".join(he_past_broken)
    he_present_b_broken = [bah, kasra, first_root_letter, fatha, second_root_letter, damma, kasra, third_root_letter]
    he_present_b_string = "".join(he_present_b_broken)
    he_command_string = ""
    he_present_broken = [yah, kasra, first_root_letter, fatha, second_root_letter, damma, kasra, third_root_letter]
    he_present_string = "".join(he_present_broken)
    he_present_with_pronoun_broken = [yah, kasra, first_root_letter, fatha, second_root_letter, damma, kasra, third_root_letter, fatha, kaaf]
