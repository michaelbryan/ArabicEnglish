...
def get_chart(verb):
    ...
    he_past_broken = [alif, first_root_letter, sukun, tah, fatha, second_root_letter, shadda]
    ...
    i_past_broken = [alif, first_root_letter, sukun, tah, fatha, second_root_letter, shadda, fatha, yah, sukun, tah]
    i_past_string = "".join(i_past_broken)
    i_present_b_broken = [bah, fatha, first_root_letter, sukun, tah, fatha, second_root_letter, shadda]
    ...
    you_m_past_broken = [alif, first_root_letter, sukun, tah, fatha, second_root_letter, shadda, fatha, yah, sukun, tah]
    you_m_past_string = "".join(you_m_past_broken)
    you_m_present_b_broken = [bah, sukun, tah, kasra, first_root_letter, sukun, tah, fatha, second_root_letter, shadda]
    you_m_present_b_string = "".join(you_m_present_b_broken)
    you_m_command_broken = [alif, first_root_letter, sukun, tah, fatha, second_root_letter, shadda]
    ...
    you_f_past_broken = [alif, first_root_letter, sukun, tah, fatha, second_root_letter, shadda, fatha, yah, sukun, tah, kasra, yah]
    you_f_past_string = "".join(you_f_past_broken)
    you_f_present_b_broken = [bah, sukun, tah, kasra, first_root_letter, sukun, tah, fatha, second_root_letter, shadda, kasra, yah]
    you_f_present_b_string = "".join(you_f_present_b_broken)
    you_f_command_broken = [alif, first_root_letter, sukun, tah, fatha, second_root_letter, shadda, kasra, yah]
    ...
    he_past_broken = [alif, first_root_letter, sukun, tah, fatha, second_root_letter, shadda]
    he_past_string = "".join(he_past_broken)
    he_present_b_broken = [bah, kasra, first_root_letter, sukun, tah, fatha, second_root_letter, shadda]
    ...
    she_past_broken = [alif, first_root_letter, sukun, tah, fatha, second_root_letter, shadda, fatha, tah]
    she_past_string = "".join(she_past_broken)
    she_present_b_broken = [bah, sukun, tah, kasra, first_root_letter, sukun, tah, fatha, second_root_letter, shadda]
    ...
    we_past_broken = [alif, first_root_letter, sukun, tah, fatha, second_root_letter, shadda, fatha, yah, sukun, noon, alif]
    we_past_string = "".join(we_past_broken)
    we_present_b_broken = [meem, sukun, noon, kasra, first_root_letter, sukun, tah, fatha, second_root_letter, shadda]
    ...
    you_all_past_broken = [alif, first_root_letter, sukun, tah, fatha, second_root_letter, shadda, fatha, yah, sukun, tah, damma, waw, alif]
    you_all_past_string = "".join(you_all_past_broken)
    you_all_present_b_broken = [bah, sukun, tah, kasra, first_root_letter, sukun, tah, fatha, second_root_letter, shadda, damma, waw, alif]
    you_all_present_b_string = "".join(you_all_present_b_broken)
    you_all_command_broken = [alif, first_root_letter, sukun, tah, fatha, second_root_letter, shadda, damma, waw, alif]
    ...
    they_past_broken = [alif, first_root_letter, sukun, tah, fatha, second_root_letter, shadda, damma, waw, alif]
    they_past_string = "".join(they_past_broken)
    they_present_b_broken = [bah, kasra, first_root_letter, sukun, tah, fatha, second_root_letter, shadda, damma, waw, alif]
    ...
    direct_object_broken = [meem, damma, first_root_letter, sukun, tah, fatha, second_root_letter, shadda]
