...
class Entry:
    ...
    def verb_chart_1i(self):
        ...
        active_participle_broken = [meem, fatha, " ", fah, kasra, yah, hah, "\:", " ", meem, damma, seen, sukun, tah, fatha, ein, sukun, meem, fatha, lam, "\n", "\'", first_root_letter, fatha, second_root_letter, kasra, yah, third_root_letter, "\'"]
        active_participle_string = "".join(active_participle_broken)
        direct_object_broken = [meem, fatha, " ", fah, kasra, yah]
        direct_object_string = "".join(direct_object_broken)
        verbal_noun_broken = [first_root_letter, alif_madda, third_root_letter, tah_marbuuta]
