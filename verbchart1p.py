...
class Entry:
    ...
    def verb_chart_1p(self):
        ...
        i_command_string = ""
        i_present_broken = [alif_madda, second_root_letter, damma, third_root_letter]
        i_present_string = "".join(i_present_broken)
        i_present_with_pronoun_broken = [alif_madda, second_root_letter, damma, third_root_letter, sukun, hah, damma, meem]
        ...
        active_participle_broken = [meem, alif_madda, second_root_letter, kasra, third_root_letter]
