...
class TextInput(Widget):
    ...
    def _create_line_label(self, text, hint=False):
        ...
        ##### My changes!  Discard if needed!
        ##### sudo cp textinput.py /usr/local/lib/python2.7/dist-packages/Kivy-1.7.2-py2.7-linux-x86_64.egg/kivy/uix
        ##### above is what's needed to replace current textinput.py file with this one
