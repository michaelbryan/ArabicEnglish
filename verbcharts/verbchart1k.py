...
def get_chart(verb):
    ...
    i_past_broken = [first_root_letter, sukun, second_root_letter, kasra, third_root_letter, tah]
    i_past_string = "".join(i_past_broken)
    i_present_b_broken = [bah, fatha, first_root_letter, sukun, second_root_letter, alif_maksura]
    i_present_b_string = "".join(i_present_b_broken)
    i_command_string = ""
    i_present_broken = [alif_hamza_above, fatha, first_root_letter, sukun, second_root_letter, alif_maksura]
    i_present_string = "".join(i_present_broken)
    i_present_with_pronoun_broken = [alif_hamza_above, fatha, first_root_letter, sukun, second_root_letter, alif_maksura, sukun, hah, damma, meem]
    ...
    you_m_past_broken = [first_root_letter, sukun, second_root_letter, kasra, third_root_letter, tah]
    you_m_past_string = "".join(you_m_past_broken)
    you_m_present_b_broken = [bah, sukun, tah, kasra, first_root_letter, sukun, second_root_letter, alif_maksura]
    you_m_present_b_string = "".join(you_m_present_b_broken)
    you_m_command_broken = [alif_hamza_below, kasra, first_root_letter, sukun, second_root_letter, alif_maksura]
    you_m_command_string = "".join(you_m_command_broken)
    you_m_present_broken = [tah, kasra, first_root_letter, sukun, second_root_letter, alif_maksura]
    you_m_present_string = "".join(you_m_present_broken)
    you_m_present_with_pronoun_broken = [tah, kasra, first_root_letter, sukun, second_root_letter, alif, hah]
    ...
    you_f_past_broken = [first_root_letter, sukun, second_root_letter, kasra, third_root_letter, tah, kasra, yah]
    ...
    he_past_broken = [first_root_letter, kasra, second_root_letter, kasra, third_root_letter]
    he_past_string = "".join(he_past_broken)
    he_present_b_broken = [bah, kasra, first_root_letter, sukun, second_root_letter, alif_maksura]
    he_present_b_string = "".join(he_present_b_broken)
    he_command_string = ""
    he_present_broken = [yah, kasra, first_root_letter, sukun, second_root_letter, alif_maksura]
    he_present_string = "".join(he_present_broken)
    he_present_with_pronoun_broken = [yah, kasra, first_root_letter, sukun, second_root_letter, alif, kaaf]
    ...
    she_present_b_broken = [bah, sukun, tah, kasra, first_root_letter, sukun, second_root_letter, alif_maksura]
    she_present_b_string = "".join(she_present_b_broken)
    she_command_string = ""
    she_present_broken = [tah, kasra, first_root_letter, sukun, second_root_letter, alif_maksura]
    she_present_string = "".join(she_present_broken)
    she_present_with_pronoun_broken = [tah, kasra, first_root_letter, sukun, second_root_letter, alif, kaaf, kasra, yah]
    ...
    we_past_broken = [first_root_letter, sukun, second_root_letter, kasra, third_root_letter, noon, alif]
    we_past_string = "".join(we_past_broken)
    we_present_b_broken = [meem, sukun, noon, kasra, first_root_letter, sukun, second_root_letter, alif_maksura]
    we_present_b_string = "".join(we_present_b_broken)
    we_command_string = ""
    we_present_broken = [noon, kasra, first_root_letter, sukun, second_root_letter, alif_maksura]
    we_present_string = "".join(we_present_broken)
    we_present_with_pronoun_broken = [noon, kasra, first_root_letter, sukun, second_root_letter, alif, kaaf, damma, meem]
    ...
    you_all_past_broken = [first_root_letter, sukun, second_root_letter, kasra, third_root_letter, tah, damma, waw, alif]
    ...
    direct_object_broken = [meem, fatha, first_root_letter, sukun, second_root_letter, kasra, third_root_letter]
    direct_object_string = "".join(direct_object_broken)
    verbal_noun_broken = [first_root_letter, kasra, second_root_letter, sukun, third_root_letter, alif, noon]
